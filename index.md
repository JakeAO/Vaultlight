...
Welcome to **Vaultlight**, a noir heist campaign set in the cosmic dark.

- Explore [Rules & Info]({{ "/info/" | relative_url }}) for FATE Condensed mechanics and cheat sheets
- Discover the [World]({{ "/world/" | relative_url }}) – its setting, revealed characters, and locations
- Read [Session Summaries]({{ "/sessions/" | relative_url }}) chronicling the crew's exploits
...
This campaign uses **FATE Condensed**, a streamlined narrative RPG system focusing on character aspects, skills, and collaborative storytelling. See the [Info section]({{ "/info/" | relative_url }}) for rules and resources.
